    ...
    <div className="container">
      ...
      <div className="row section-layout d-flex align-items-center">
        ...
        <div className="col col-lg-6 col-md-12 col-sm-12 col-12 order-lg-2">
          <h1 className="heading-1">Tại sao nên chọn  My store</h1>
          <ul>
            <li>
      ...
      <div className="col section-layout">
        <h1 className="heading-1">Cảm hứng với My store</h1>
        <p className="text">
          <strong>
          ...
          Từ niềm cảm hứng bất tận với giày, đội ngũ chúng tôi đã cho ra đời đứa con tinh thần “My store”. Với mong muốn mang đến cho khách hàng những đôi giày "chất nhất" đến từ các thương hiệu hàng đầu thế giới như Nike, Adidas, Puma, Reebok, Fila, Converse, New Balance, Asics,… với mức giá vô cùng hợp lý. Từ giày bóng đá, tennis, cầu lông cho đến giày sneaker, running, training,…</p>
      </div>
    </div>
  </div>
    </div>
